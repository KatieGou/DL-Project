...
def load_test_data():
    ...
    de_sents = [_refine(line) for line in codecs.open('newstest2019-deen-src.de.sgm', 'r', 'utf-8').read().split("\n") if _refine(line)]
    en_sents = [_refine(line) for line in codecs.open('newstest2019-deen-ref.en.sgm', 'r', 'utf-8').read().split("\n") if _refine(line)]
